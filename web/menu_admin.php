...
<body>
    ...
    <nav class="nav-main nav-ident">
        ...
        <legend class="mb-3">Painel de controle</legend>
        <hr>
        <ul class="nav-ident">
            
            <li class="nav-ident">
                <a class="link-item nav-ident liDisabled" href="internet.php">
            ...
            <li class="nav-ident">
                ...
                <ul class="dropdown-ul">
                    ...
                    <li>
                        <a href="libera_forward.php">LAN - Encaminhamento</a>
                    </li>

                    <li>
                        <a href="listagem_servicos.php">Serviços</a>
                    </li>
                </ul>
            </li>
