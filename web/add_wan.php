...
<body id="body-dashboard" class="body-add-wan body-interface">
	...
	<section class="section-main">
		...
		<article class="container">
			...
			<div class="interface">
				<div class="legend">
					<h3 class="d-inline">Adicionar interface WAN</h3>
				</div>
				<form id="formInterfaceWan" class="div-conf div-conf-enabled">
					<div class="div-info-valor div_eth" id="divEth">
						...
						<input name="interface" class="eth" type="text" value="" size="10" required=true>
					</div>
					...
					<div class="div-info-valor">
						...
						<input name="gw" class="gw" type="text" value="" size="15" required=true>
					</div>
					...
					<div class="div-info-valor">
						...
						<input name="dns1" class="" type="text" value="" size="15">
					</div>

					<div class="div-info-valor">
						<label for="">DNS Secundário: </label>
						<input name="dns2" class="" type="text" value="" size="15">
					</div>
