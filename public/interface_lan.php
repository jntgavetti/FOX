...
if (isset($_GET['interface'])) {
	...
	header("Location: listagem_lan.php");
	exit;
}
...
<body id="body-dashboard" class="body-lan body-interface">
		...
		<article id="lan" class="container">
			...
			?>
					<div class="interface">
						...
						<form id="formInterfaceLan" class="div-conf div-conf-enabled">
							...
							<div class="div-info-valor div_tipo_placa selectsPlaca" id="">
								<label for="">Tipo de placa: </label>
								<?php echo '<input name="tipo_placa" class="tipo_placa" type="text" disabled=true value="' . $coluna["tipo_placa"] . '">'; ?>
							</div>
							<div class="div-info-valor div_class_placa selectsPlaca" id="divClassPlaca">
								<label for="">Classificação: </label>
								<select name="class_placa" class="" id="selectClassPlaca">
									<?php
							...
							<div class="div-info-valor selectsPlaca" id="divStatusPlaca">
							...
							<div class="div-info-valor">
								...
								<?php echo '<input name="ip" class="" type="text" value="' . $coluna["ip"] . '" required=true>'; ?>
							</div>
							<div class="div-info-valor">
